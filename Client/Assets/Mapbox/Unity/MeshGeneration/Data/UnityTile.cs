...
namespace Mapbox.Unity.MeshGeneration.Data
{
	...
	public class UnityTile : MonoBehaviour
	{
		...
		internal void Recycle()
		{
			...
			{
				MeshRenderer.sharedMaterial.SetTexture(BaseMap, _loadingTexture);
			}
		...
		public void SetRasterData(byte[] data, bool useMipMap = true, bool useCompression = false)
		{
			...
			if (RasterDataState != TilePropertyState.Unregistered)
			{
				...
				if (data == null)
				{
					MeshRenderer.material.SetTexture(BaseMap, null);
					return;
				}
				...
				MeshRenderer.sharedMaterial.SetTexture(BaseMap, _rasterData);
		...
		{
			MeshRenderer.material.SetTexture(BaseMap, texture);
		}
